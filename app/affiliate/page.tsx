        ...
        <div className="bg-paper">
                ...
                <div className="px-4 py-12">
                    <div className="grid grid-cols-2 items-center justify-between">
                        ...
                        <div className="w-full space-y-4 mini-laptop:space-y-8 laptop:space-y-8 desktop:space-y-12">
                            <p className="mobile:text-3xl text-4xl desktop:text-5xl font-bold font-robotoslab text-[#4A2511]">
                                Chương trình tiếp thị liên kết
                            </p>
                            <p className="mobile:text-sm tablet:text-md text-lg laptop:text-xl desktop:text-2xl font-robotoflex">
            ...
            <div className="w-full max-w-[100rem] mx-auto px-4 py-8 laptop:py-12 desktop:py-12">
                <div className="w-full bg-[#F0E0CA] mb-8 drop-shadow-lg border-1 border-black text-[#4A2511]">
                    <p className="mobile:text-3xl text-4xl desktop:text-5xl font-robotoslab font-bold text-center p-2">Lợi ích bạn nhận được</p>
                </div>

                <p className="text-center font-robotoflex font-medium mobile:my-10 my-12 desktop:my-16 mobile:text-base text-lg desktop:text-2xl">
            ...
            <div className="w-full max-w-[100rem] mx-auto px-4 py-8 desktop:py-12">
                <div className="w-full bg-[#F0E0CA] mb-8 drop-shadow-lg border-1 border-black text-[#4A2511]">
                    <p className="mobile:text-3xl text-4xl desktop:text-5xl font-robotoslab font-bold text-center p-2">Làm sao để tham gia</p>
                </div>
                        ...
                        {steps.map((step, index) => (
                            <div key={step.number} className="flex flex-col items-center">
                                ...
                                <Card className="w-full p-6 mobile:mt-0 mt-4 h-full">
                                    <p className="font-robotoflex font-medium text-center mobile:text-base text-lg desktop:text-2xl">{step.description}</p>
                                </Card>
                            </div>
                        ))}
                    </div>
                ...
                <div className="text-center mt-12">
                    <Button className="bg-[#7A0505] text-white font-medium py-3 px-8 rounded-2xl text-lg desktop:text-2xl h-full">
                        Đăng kí ngay
                    </Button>
                </div>
            </div>
