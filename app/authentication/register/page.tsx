        ...
        <div className="relative">
            ...
            <div className="relative desktop:px-8 z-10 mx-auto px-4 mobile:px-8 py-16 max-w-screen-xl text-[#3F291B]">
                <div className="mx-auto max-w-lg text-center">
                    <h1 className="font-bold desktop:text-3xl mobile:text-3xl mini-laptop:text-3xl laptop:text-3xl tablet:text-3xl">Đăng ký</h1>
                ...
                <div>
                    <form className="space-y-4 mx-auto mt-8 mb-0 max-w-md">
                        <div className="flex flex-col">
                            <div className="mb-4">
                                <AuthInput id="name" label="Họ và tên" type="text" placeholder={"Nhập họ và tên"} />
                                <AuthInput id="tel" label="Số điện thoại" type="tel" placeholder={"Nhập số điện thoại"} />
                                <AuthInput id="email" label="Email" type="email" placeholder={"Nhập email"} />
                                <AuthInput id="pasword" label="Mật khẩu" type="password" placeholder={"Nhập mật khẩu"} />
                                <AuthInput id="repassword" label="Nhập lại mật khẩu" type="password" placeholder={"Nhập lại mật khẩu"} />
                            </div>
