...
export default function WhyChoosingCard(props: WhyChoosingCardProps) {
    return (
        <Card className="m-2 bg-[#F0E0CA] hover:scale-110 w-fit h-full">
            ...
            <CardBody className="pb-4 pt-0 items-center">
                <p className="text-[#D7A444] uppercase font-bold text-center text-lg laptop:text-small">{props.title}</p>
            </CardBody>
        </Card>
    );
}