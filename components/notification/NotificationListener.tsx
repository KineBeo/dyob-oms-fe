    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ...
                className="relative bg-[#FBF6EC] p-2 rounded-full font-medium text-text-brown-primary laptop:text-lg desktop:text-lg hover:text-[#D7A444] hover:scale-110"
            >
                <Bell size={24} />
                {unreadCount > 0 && (
            ...
            {/* Dropdown Menu */}
            {isOpen && (
                <div className="right-0 z-50 absolute bg-white shadow-lg mt-2 border rounded-lg w-80">
                    {/* Header */}
